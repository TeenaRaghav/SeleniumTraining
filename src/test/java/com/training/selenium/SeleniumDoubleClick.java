...
//		 perform click operation on login button
	...
	WebElement dblclk = driver.findElement(By.xpath("//a[contains(text(),'Double Click')]"));
	dblclk.click();
	Thread.sleep(4000);
	WebElement btndblclick = driver.findElement(By.xpath("//button[contains(text(),'Double Click')]"));
	action = new Actions(driver);
	action.doubleClick(btndblclick).build().perform();
	Thread.sleep(4000);
//	System.out.println(btndblclick.getText());
//	Thread.sleep(4000);
//	
	}
